...
General structure: \* `config/` directory contains configuration information, including the central `config.yml` file. \* `data/` directory contains all the source and processed data. \* `doc/` directory contains documentation material. \* `env/` directory contains conda environments. \* `results/` directory contains results generated by the data analysis code found in `src/`. \* `src/` directory contains all the code to perform the analyses. It is first divided by programming language, then by workflow.
